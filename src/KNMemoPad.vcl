...
<h3>コマンド ライン</h3>
Creating command line "rc.exe /l 0x411 /fo"ARMV4IDbg/resource.res" /d UNDER_CE=400 /d _WIN32_WCE=400 /d "UNICODE" /d "_UNICODE" /d "DEBUG" /d "WCE_PLATFORM_STANDARDSDK" /d "THUMB" /d "_THUMB_" /d "ARM" /d "_ARM_" /d "ARMV4I" /r "F:\Programming\KN MemoPad\src\resource.rc"" 
一時ファイル "C:\DOCUME~1\WATA\LOCALS~1\Temp\RSP6E.tmp" を作成し、次の内容を記録します
[
...
Creating command line "clarm.exe @C:\DOCUME~1\WATA\LOCALS~1\Temp\RSP6E.tmp" 
一時ファイル "C:\DOCUME~1\WATA\LOCALS~1\Temp\RSP6F.tmp" を作成し、次の内容を記録します
[
...
コマンド ライン "link.exe @C:\DOCUME~1\WATA\LOCALS~1\Temp\RSP6F.tmp" の作成中
<h3>アウトプット ウィンドウ</h3>
リソースをコンパイル中...
コンパイル中...
knmemopad.cpp
